...
"use strict";
var KTIntentcanvas = function(elementId, options) {
    // Main object
    var the = this;
    var init = false;
        ...
        KTUtil.scrollInit(messageListEl, {
            ...
            height: function() { // calculate height
                ...
                if (KTUtil.isInResponsiveRange('tablet-and-mobile')) {
                    return KTUtil.hasAttr(messageListEl, 'data-mobile-height') ? parseInt(KTUtil.attr(messageListEl, 'data-mobile-height')) : 400;
                }
                ...
                if (chatEl) {
                    height = height - parseInt(KTUtil.css(chatEl, 'margin-top')) - parseInt(KTUtil.css(chatEl, 'margin-bottom')) + 60;
