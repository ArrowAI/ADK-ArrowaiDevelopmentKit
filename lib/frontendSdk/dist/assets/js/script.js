...
(function($) {
	...
	// jQuery(window).on('load resize', function () {
		...
		$(".open_profile").on('click', function () {
			...
			$('#open_profile').addClass('hide');
			$('#open_profile').removeClass('show');
			$('#close_profile').addClass('show');
			$('#close_profile').removeClass('hide');
		...
		$(".close_profile").on('click', function () {	
			$('#close_profile').addClass('hide');
			$('#close_profile').removeClass('show');
			$('#open_profile').addClass('show');
			$('#open_profile').removeClass('hide');
