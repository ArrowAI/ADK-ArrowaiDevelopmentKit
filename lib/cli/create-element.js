...
createExtrnalModule: (elementDir,projectName) => {
    replace({
        regex: "element",
        replacement: projectName,
        paths: [`${elementDir}/angular.json`],
        recursive: true,
        silent: true,
    });
}
...
module.exports = {
    run: (sdkDir) => {
        ...
        fs.copySync(path.resolve(`${sdkDir}/dist/main.js`), `${path.join(__dirname)}/../frontendSdk/dist/element/main.js`);
        app.use(express.static(path.join(__dirname + '/../frontendSdk/dist')));
        ...
        app.get('/', function (req, res) {
            ...
            res.render(path.join(__dirname + `/../frontendSdk/dist/index.html`));
        });
